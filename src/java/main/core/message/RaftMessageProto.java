...
public final class RaftMessageProto {
  ...
  public enum MessageType
     ...
     * <code>ADD_NEW_NODE = 6;</code>
     */
    public static final int ADD_NEW_NODE_VALUE = 6;
  ...
  public interface RaftMessageOrBuilder extends
    ...
    /**
     * <code>.core.message.AddNewNodeMessage add_new_node_message = 12;</code>
     */
    boolean hasAddNewNodeMessage();
    /**
     * <code>.core.message.AddNewNodeMessage add_new_node_message = 12;</code>
     */
    RaftMessageProto.AddNewNodeMessage getAddNewNodeMessage();
    /**
     * <code>.core.message.AddNewNodeMessage add_new_node_message = 12;</code>
     */
    RaftMessageProto.AddNewNodeMessageOrBuilder getAddNewNodeMessageOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 98: {
              RaftMessageProto.AddNewNodeMessage.Builder subBuilder = null;
              if (messageBodyCase_ == 12) {
                subBuilder = ((RaftMessageProto.AddNewNodeMessage) messageBody_).toBuilder();
              }
              messageBody_ =
                  input.readMessage(RaftMessageProto.AddNewNodeMessage.parser(), extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom((RaftMessageProto.AddNewNodeMessage) messageBody_);
                messageBody_ = subBuilder.buildPartial();
              }
              messageBodyCase_ = 12;
              break;
    ...
    public enum MessageBodyCase
      ...
      public static MessageBodyCase forNumber(int value) {
        switch (value) {
          ...
          case 12: return ADD_NEW_NODE_MESSAGE;
    ...
    public static final int ADD_NEW_NODE_MESSAGE_FIELD_NUMBER = 12;
    /**
     * <code>.core.message.AddNewNodeMessage add_new_node_message = 12;</code>
     */
    public boolean hasAddNewNodeMessage() {
      return messageBodyCase_ == 12;
    }
    /**
     * <code>.core.message.AddNewNodeMessage add_new_node_message = 12;</code>
     */
    public RaftMessageProto.AddNewNodeMessage getAddNewNodeMessage() {
      if (messageBodyCase_ == 12) {
         return (RaftMessageProto.AddNewNodeMessage) messageBody_;
      }
      return RaftMessageProto.AddNewNodeMessage.getDefaultInstance();
    }
    /**
     * <code>.core.message.AddNewNodeMessage add_new_node_message = 12;</code>
     */
    public RaftMessageProto.AddNewNodeMessageOrBuilder getAddNewNodeMessageOrBuilder() {
      if (messageBodyCase_ == 12) {
         return (RaftMessageProto.AddNewNodeMessage) messageBody_;
      }
      return RaftMessageProto.AddNewNodeMessage.getDefaultInstance();
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (messageBodyCase_ == 12) {
        output.writeMessage(12, (RaftMessageProto.AddNewNodeMessage) messageBody_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (messageBodyCase_ == 12) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(12, (RaftMessageProto.AddNewNodeMessage) messageBody_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      switch (messageBodyCase_) {
        ...
        case 11:
          ...
          break;
        case 12:
          if (!getAddNewNodeMessage()
              .equals(other.getAddNewNodeMessage())) return false;
          break;
        case 0:
        default:
      }
    ...
    public int hashCode() {
      ...
      switch (messageBodyCase_) {
        ...
        case 11:
          ...
          break;
        case 12:
          hash = (37 * hash) + ADD_NEW_NODE_MESSAGE_FIELD_NUMBER;
          hash = (53 * hash) + getAddNewNodeMessage().hashCode();
          break;
        case 0:
        default:
      }
    ...
    public static final class Builder extends
      ...
      public RaftMessageProto.RaftMessage buildPartial() {
        ...
        if (messageBodyCase_ == 12) {
          if (addNewNodeMessageBuilder_ == null) {
            result.messageBody_ = messageBody_;
          } else {
            result.messageBody_ = addNewNodeMessageBuilder_.build();
          }
        }
      ...
      public Builder mergeFrom(RaftMessageProto.RaftMessage other) {
        ...
        switch (other.getMessageBodyCase()) {
          ...
          case ADD_NEW_NODE_MESSAGE: {
            mergeAddNewNodeMessage(other.getAddNewNodeMessage());
            break;
          }
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          RaftMessageProto.AddNewNodeMessage, RaftMessageProto.AddNewNodeMessage.Builder, RaftMessageProto.AddNewNodeMessageOrBuilder> addNewNodeMessageBuilder_;
      /**
       * <code>.core.message.AddNewNodeMessage add_new_node_message = 12;</code>
       */
      public boolean hasAddNewNodeMessage() {
      ...
      public RaftMessageProto.AddNewNodeMessage getAddNewNodeMessage() {
        if (addNewNodeMessageBuilder_ == null) {
          ...
          if (messageBodyCase_ == 12) {
            return addNewNodeMessageBuilder_.getMessage();
          }
          return RaftMessageProto.AddNewNodeMessage.getDefaultInstance();
        }
      }
       ...
       * <code>.core.message.AddNewNodeMessage add_new_node_message = 12;</code>
       */
      public Builder setAddNewNodeMessage(RaftMessageProto.AddNewNodeMessage value) {
        if (addNewNodeMessageBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
          ...
          addNewNodeMessageBuilder_.setMessage(value);
        }
        messageBodyCase_ = 12;
        return this;
      }
       ...
       * <code>.core.message.AddNewNodeMessage add_new_node_message = 12;</code>
       */
      public Builder setAddNewNodeMessage(
          RaftMessageProto.AddNewNodeMessage.Builder builderForValue) {
        if (addNewNodeMessageBuilder_ == null) {
          messageBody_ = builderForValue.build();
          onChanged();
        } else {
          addNewNodeMessageBuilder_.setMessage(builderForValue.build());
        }
        messageBodyCase_ = 12;
        return this;
      }
       ...
       * <code>.core.message.AddNewNodeMessage add_new_node_message = 12;</code>
       */
      public Builder mergeAddNewNodeMessage(RaftMessageProto.AddNewNodeMessage value) {
        if (addNewNodeMessageBuilder_ == null) {
          if (messageBodyCase_ == 12 &&
              messageBody_ != RaftMessageProto.AddNewNodeMessage.getDefaultInstance()) {
            messageBody_ = RaftMessageProto.AddNewNodeMessage.newBuilder((RaftMessageProto.AddNewNodeMessage) messageBody_)
                .mergeFrom(value).buildPartial();
          } else {
            messageBody_ = value;
          }
          ...
          if (messageBodyCase_ == 12) {
            addNewNodeMessageBuilder_.mergeFrom(value);
          }
          addNewNodeMessageBuilder_.setMessage(value);
        }
        messageBodyCase_ = 12;
       ...
       * <code>.core.message.AddNewNodeMessage add_new_node_message = 12;</code>
       */
      public Builder clearAddNewNodeMessage() {
        if (addNewNodeMessageBuilder_ == null) {
          if (messageBodyCase_ == 12) {
            messageBodyCase_ = 0;
            messageBody_ = null;
          ...
          addNewNodeMessageBuilder_.clear();
        }
        return this;
      }
      /**
       * <code>.core.message.AddNewNodeMessage add_new_node_message = 12;</code>
       */
      public RaftMessageProto.AddNewNodeMessage.Builder getAddNewNodeMessageBuilder() {
        return getAddNewNodeMessageFieldBuilder().getBuilder();
      }
      /**
       * <code>.core.message.AddNewNodeMessage add_new_node_message = 12;</code>
       */
      public RaftMessageProto.AddNewNodeMessageOrBuilder getAddNewNodeMessageOrBuilder() {
        if ((messageBodyCase_ == 12) && (addNewNodeMessageBuilder_ != null)) {
          return addNewNodeMessageBuilder_.getMessageOrBuilder();
        } else {
          if (messageBodyCase_ == 12) {
            return (RaftMessageProto.AddNewNodeMessage) messageBody_;
          }
       ...
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          RaftMessageProto.AddNewNodeMessage, RaftMessageProto.AddNewNodeMessage.Builder, RaftMessageProto.AddNewNodeMessageOrBuilder> 
          getAddNewNodeMessageFieldBuilder() {
        if (addNewNodeMessageBuilder_ == null) {
          if (!(messageBodyCase_ == 12)) {
            messageBody_ = RaftMessageProto.AddNewNodeMessage.getDefaultInstance();
          }
          addNewNodeMessageBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              RaftMessageProto.AddNewNodeMessage, RaftMessageProto.AddNewNodeMessage.Builder, RaftMessageProto.AddNewNodeMessageOrBuilder>(
                  (RaftMessageProto.AddNewNodeMessage) messageBody_,
                  getParentForChildren(),
                  isClean());
          messageBody_ = null;
        }
        messageBodyCase_ = 12;
        onChanged();;
        return addNewNodeMessageBuilder_;
      }
      @java.lang.Override
  ...
  public interface AddNewNodeMessageOrBuilder extends
      // @@protoc_insertion_point(interface_extends:core.message.AddNewNodeMessage)
      com.google.protobuf.MessageOrBuilder {

    /**
     * <code>string add_node_message = 1;</code>
     */
    java.lang.String getAddNodeMessage();
    /**
     * <code>string add_node_message = 1;</code>
     */
    com.google.protobuf.ByteString
        getAddNodeMessageBytes();
  }
  /**
   * Protobuf type {@code core.message.AddNewNodeMessage}
   */
  public  static final class AddNewNodeMessage extends
      com.google.protobuf.GeneratedMessageV3 implements
      // @@protoc_insertion_point(message_implements:core.message.AddNewNodeMessage)
      AddNewNodeMessageOrBuilder {
  private static final long serialVersionUID = 0L;
    // Use AddNewNodeMessage.newBuilder() to construct.
    private AddNewNodeMessage(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
      super(builder);
    }
    private AddNewNodeMessage() {
      addNodeMessage_ = "";
    }
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return RaftMessageProto.internal_static_core_message_AddNewNodeMessage_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return RaftMessageProto.internal_static_core_message_AddNewNodeMessage_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              RaftMessageProto.AddNewNodeMessage.class, RaftMessageProto.AddNewNodeMessage.Builder.class);
    }

    public static final int ADD_NODE_MESSAGE_FIELD_NUMBER = 1;
    private volatile java.lang.Object addNodeMessage_;
    /**
     * <code>string add_node_message = 1;</code>
     */
    public java.lang.String getAddNodeMessage() {
      java.lang.Object ref = addNodeMessage_;
      if (ref instanceof java.lang.String) {
        return (java.lang.String) ref;
      } else {
        com.google.protobuf.ByteString bs = 
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
                        throws java.io.IOException {
      if (!getAddNodeMessageBytes().isEmpty()) {
        com.google.protobuf.GeneratedMessageV3.writeString(output, 1, addNodeMessage_);
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (!getAddNodeMessageBytes().isEmpty()) {
        size += com.google.protobuf.GeneratedMessageV3.computeStringSize(1, addNodeMessage_);
      }
      size += unknownFields.getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof RaftMessageProto.AddNewNodeMessage)) {
        return super.equals(obj);
      }
      RaftMessageProto.AddNewNodeMessage other = (RaftMessageProto.AddNewNodeMessage) obj;

      if (!getAddNodeMessage()
          .equals(other.getAddNodeMessage())) return false;
      if (!unknownFields.equals(other.unknownFields)) return false;
      return true;
    }
    ...
    public int hashCode() {
      ...
      int hash = 41;
      hash = (19 * hash) + getDescriptor().hashCode();
      hash = (37 * hash) + ADD_NODE_MESSAGE_FIELD_NUMBER;
      hash = (53 * hash) + getAddNodeMessage().hashCode();
      hash = (29 * hash) + unknownFields.hashCode();
      memoizedHashCode = hash;
      return hash;
    }

    public static RaftMessageProto.AddNewNodeMessage parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static RaftMessageProto.AddNewNodeMessage parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static RaftMessageProto.AddNewNodeMessage parseFrom(
    ...
    public static RaftMessageProto.AddNewNodeMessage parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static RaftMessageProto.AddNewNodeMessage parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static RaftMessageProto.AddNewNodeMessage parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(RaftMessageProto.AddNewNodeMessage prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        com.google.protobuf.GeneratedMessageV3.Builder<Builder> implements
        // @@protoc_insertion_point(builder_implements:core.message.AddNewNodeMessage)
        RaftMessageProto.AddNewNodeMessageOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return RaftMessageProto.internal_static_core_message_AddNewNodeMessage_descriptor;
      }
      ...
      // Construct using RaftMessageProto.AddNewNodeMessage.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      @java.lang.Override
      public RaftMessageProto.AddNewNodeMessage getDefaultInstanceForType() {
        return RaftMessageProto.AddNewNodeMessage.getDefaultInstance();
      }

      @java.lang.Override
      public RaftMessageProto.AddNewNodeMessage build() {
        RaftMessageProto.AddNewNodeMessage result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public RaftMessageProto.AddNewNodeMessage buildPartial() {
        RaftMessageProto.AddNewNodeMessage result = new RaftMessageProto.AddNewNodeMessage(this);
        result.addNodeMessage_ = addNodeMessage_;
        onBuilt();
        return result;
      }
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof RaftMessageProto.AddNewNodeMessage) {
          return mergeFrom((RaftMessageProto.AddNewNodeMessage)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(RaftMessageProto.AddNewNodeMessage other) {
        if (other == RaftMessageProto.AddNewNodeMessage.getDefaultInstance()) return this;
        if (!other.getAddNodeMessage().isEmpty()) {
          addNodeMessage_ = other.addNodeMessage_;
          onChanged();
        }
        this.mergeUnknownFields(other.unknownFields);
        onChanged();
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        RaftMessageProto.AddNewNodeMessage parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (RaftMessageProto.AddNewNodeMessage) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      private java.lang.Object addNodeMessage_ = "";
      /**
       * <code>string add_node_message = 1;</code>
       */
      public java.lang.String getAddNodeMessage() {
       ...
       * <code>string add_node_message = 1;</code>
       */
      public Builder setAddNodeMessage(
          java.lang.String value) {
        if (value == null) {
    throw new NullPointerException();
  }
  
        addNodeMessage_ = value;
        onChanged();
        return this;
      }
      /**
       * <code>string add_node_message = 1;</code>
       */
      public Builder clearAddNodeMessage() {
        
        addNodeMessage_ = getDefaultInstance().getAddNodeMessage();
        onChanged();
        return this;
      }
      /**
       * <code>string add_node_message = 1;</code>
       */
      public Builder setAddNodeMessageBytes(
          com.google.protobuf.ByteString value) {
        if (value == null) {
    throw new NullPointerException();
  }
  checkByteStringIsUtf8(value);
      ...
      // @@protoc_insertion_point(builder_scope:core.message.AddNewNodeMessage)
    }

    // @@protoc_insertion_point(class_scope:core.message.AddNewNodeMessage)
    private static final RaftMessageProto.AddNewNodeMessage DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new RaftMessageProto.AddNewNodeMessage();
    }

    public static RaftMessageProto.AddNewNodeMessage getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }

    private static final com.google.protobuf.Parser<AddNewNodeMessage>
        PARSER = new com.google.protobuf.AbstractParser<AddNewNodeMessage>() {
      @java.lang.Override
      public AddNewNodeMessage parsePartialFrom(
          com.google.protobuf.CodedInputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return new AddNewNodeMessage(input, extensionRegistry);
      }
    };

    public static com.google.protobuf.Parser<AddNewNodeMessage> parser() {
      return PARSER;
    }

    @java.lang.Override
    public com.google.protobuf.Parser<AddNewNodeMessage> getParserForType() {
      return PARSER;
    }
  ...
  private static final com.google.protobuf.Descriptors.Descriptor
    internal_static_core_message_AddNewNodeMessage_descriptor;
  private static final 
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internal_static_core_message_AddNewNodeMessage_fieldAccessorTable;
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\021RaftMessage.proto\022\014core.message\"\231\004\n\013Ra" +
      ...
      "NodeMessageH\000\022?\n\024add_new_node_message\030\014 " +
      "\001(\0132\037.core.message.AddNewNodeMessageH\000B\r" +
      "\n\013MessageBody\"\"\n\016PreVoteMessage\022\020\n\010vote_" +
      "for\030\001 \001(\010\"\037\n\013VoteMessage\022\020\n\010vote_for\030\001 \001" +
      "(\010\"\016\n\014HeartMessage\"\037\n\nAckMessage\022\021\n\tack_" +
      "index\030\001 \001(\003\"\'\n\rCommitMessage\022\026\n\016commit_m" +
      "essage\030\001 \001(\t\"#\n\013NodeMessage\022\024\n\014node_mess" +
      "age\030\001 \001(\t\"-\n\021AddNewNodeMessage\022\030\n\020add_no" +
      "de_message\030\001 \001(\t*a\n\013MessageType\022\014\n\010PRE_V" +
      "OTE\020\000\022\010\n\004VOTE\020\001\022\t\n\005HEART\020\002\022\007\n\003ACK\020\003\022\n\n\006C" +
      "OMMIT\020\004\022\010\n\004NODE\020\005\022\020\n\014ADD_NEW_NODE\020\006B\024\n\000B" +
      "\020RaftMessageProtob\006proto3"
    };
    ...
    internal_static_core_message_RaftMessage_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_core_message_RaftMessage_descriptor,
        new java.lang.String[] { "MessageType", "Id", "CurrentTerm", "LastAppliedIndex", "Leader", "PreVoteMessage", "VoteMessage", "HeartMessage", "AckMessage", "CommitMessage", "NodeMessage", "AddNewNodeMessage", "MessageBody", });
    internal_static_core_message_PreVoteMessage_descriptor =
    ...
    internal_static_core_message_AddNewNodeMessage_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_core_message_AddNewNodeMessage_descriptor,
        new java.lang.String[] { "AddNodeMessage", });
  }
