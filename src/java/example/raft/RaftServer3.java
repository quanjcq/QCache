...
public class RaftServer3 {
    public static void main(String[] args) {
        ...
        Node myNode = nodes.get(2);
        ConsistentHash consistentHash = new ConsistentHash(1);

        //checkPoint
        String checkPointFilePath = "/home/jcq/store/2/0";
        CheckPoint checkPoint = new CheckPoint(checkPointFilePath);

        //raftLog
        String raftLogFilePath = "/home/jcq/store/2/00";
        ...
        //state machine
        String raftStateFilePath = "/home/jcq/store/2/000";
